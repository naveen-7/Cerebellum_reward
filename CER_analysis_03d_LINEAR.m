...
W_PREV_T_p = PSTH_RETURN_n(Spikes.S(IND,:),Infos(IND,4),Start_T,End_T,SIG); % Aligned to target
...
W_PREV_M_p = PSTH_RETURN_n(Spikes.S(IND,:),Infos(IND,11),Start_M,End_M,SIG); % Aligned to target
...
C_PREV_T_p = PSTH_RETURN_n(Spikes.S(IND,:),Infos(IND,4),Start_T,End_T,SIG); % Aligned to target
...
C_PREV_M_p = PSTH_RETURN_n(Spikes.S(IND,:),Infos(IND,11),Start_M,End_M,SIG); % Aligned to target
...
W_CURR_T_p = PSTH_RETURN_n(Spikes.S(IND,:),Infos(IND,4),Start_T,End_T,SIG); % Aligned to target
...
W_CURR_M_p = PSTH_RETURN_n(Spikes.S(IND,:),Infos(IND,11),Start_M,End_M,SIG); % Aligned to target
...
C_CURR_T_p = PSTH_RETURN_n(Spikes.S(IND,:),Infos(IND,4),Start_T,End_T,SIG); % Aligned to target
...
C_CURR_M_p = PSTH_RETURN_n(Spikes.S(IND,:),Infos(IND,11),Start_M,End_M,SIG); % Aligned to target
...
% % % % % %% Target histogram poop
% % % % % F = figure;
% % % % % subplot(5,5,1)
% % % % % clear temp;
% % % % % temp = Infos(:,4)-Infos(:,11);
% % % % % h = histogram(temp,8);
...
CW_DELTA.PREV = TEMPTEMP(1:length(PREV_TEMP));
CW_DELTA.CURR = TEMPTEMP(length(PREV_TEMP)+1:length(TEMPTEMP));
% 
% 
...
% % % %%%% P VALUES-----------
% % % 
% % % for i=1:size(W_PREV_T_p,2)
% % %     PREV_T_p(1,i) = ttest_NN(W_PREV_T_p(:,i),C_PREV_T_p(:,i));
% % %     PREV_M_p(1,i) = ttest_NN(W_PREV_M_p(:,i),C_PREV_M_p(:,i));
% % %     CURR_T_p(1,i) = ttest_NN(W_CURR_T_p(:,i),C_CURR_T_p(:,i));
% % %     CURR_M_p(1,i) = ttest_NN(W_CURR_M_p(:,i),C_CURR_M_p(:,i));
% % % end
% % % 
% % % 
% % % PREV_TEMP_p = (([PREV_T_p(1,:) PREV_M_p(1,:)]));
% % % CURR_TEMP_p = (([CURR_T_p(1,:) CURR_M_p(1,:)]));
% % % CW_DELTA.PREV_p = PREV_TEMP_p;
% % % CW_DELTA.CURR_p = CURR_TEMP_p;
% % %  
% % % 
% % % 
% % % F = figure;
% % % subplot(10,1,[1 2 3 4])
% % % hold on;
% % % plot(1:length(CW_DELTA.TIME),CW_DELTA.PREV_p,'color',[0.6 0.6 0.6])
% % % value = [1,abs(Start_T)+1,End_T-Start_T-100,End_T-Start_T+100, End_T-Start_T+abs(Start_M), length(CW_DELTA.TIME) ];
% % % set(gca, 'XTick', value);
% % % set(gca, 'XTickLabel', {num2str(Start_T),'0',num2str(End_T-100),num2str(Start_M+100),'0',num2str(End_M)},'fontsize',5);
% % % xlim([1 length(CW_DELTA.TIME)])
% % % plot(xlim,[0.05 0.05],'-r','linewidth',2);
% % % 
% % % 
% % % subplot(10,1,[5 6 7 8])
% % % hold on;
% % % plot(1:length(CW_DELTA.TIME),CW_DELTA.CURR_p,'color',[0.6 0.6 0.6])
% % % value = [1,abs(Start_T)+1,End_T-Start_T-100,End_T-Start_T+100, End_T-Start_T+abs(Start_M), length(CW_DELTA.TIME) ];
% % % set(gca, 'XTick', value);
% % % set(gca, 'XTickLabel', {num2str(Start_T),'0',num2str(End_T-100),num2str(Start_M+100),'0',num2str(End_M)},'fontsize',5);
% % % xlim([1 length(CW_DELTA.TIME)])
...
% % % 
% % % subplot(10,1,[9])
% % % image(log(CW_DELTA.PREV_p'),'CDataMapping','scaled')
% % % value = [1,abs(Start_T)+1,End_T-Start_T-100,End_T-Start_T+100, End_T-Start_T+abs(Start_M), length(CW_DELTA.TIME) ];
% % % set(gca, 'XTick', value);
% % % set(gca, 'XTickLabel', {num2str(Start_T),'0',num2str(End_T-100),num2str(Start_M+100),'0',num2str(End_M)},'fontsize',5);
% % % xlim([1 length(CW_DELTA.TIME)])
...
% % % 
% % % subplot(10,1,[10])
% % % image(log(CW_DELTA.CURR_p'),'CDataMapping','scaled')
% % % value = [1,abs(Start_T)+1,End_T-Start_T-100,End_T-Start_T+100, End_T-Start_T+abs(Start_M), length(CW_DELTA.TIME) ];
% % % set(gca, 'XTick', value);
% % % set(gca, 'XTickLabel', {num2str(Start_T),'0',num2str(End_T-100),num2str(Start_M+100),'0',num2str(End_M)},'fontsize',5);
% % % xlim([1 length(CW_DELTA.TIME)])
...
% % % 
% % % cd(Results_dir)
% % % filename = strcat(NOME,'ColorDELTA_p');
% % % print(F, '-dpdf', filename, '-r400')
% % % 
% % % 
