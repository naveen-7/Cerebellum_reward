...
% function CER_analysis_02_AFTER
...
cd(data_dir)
disp('!!! CER_analysis_02 has started running !!!');
...
% $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ %
% $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ %
save(MERGE_file,'CHANGE','per_corr_LC','x_trial_LC','LEARNT','w_bin','s_bin','RT_tot_LC','-append');
save(ALLCELLS_file,'CHANGE','per_corr_LC','x_trial_LC','LEARNT','w_bin','s_bin','RT_tot_LC','-append');
% $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ %
% $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ %
...
save(MERGE_file,'CHANGE','x_trial_Nbin','per_corr_Nbin','RT_tot_Nbin','LEARNT');
...
ylabel('RT');
box off;
title(strcat(FileName1(6:13),'-',FileName1(15:17),'-RT-CORR-WRNG'));
cd(Results_dir)
filename = strcat(FileName1(6:17),'_RT_CORR_WRNG');
