...
% function CER_analysis_01_LICK2
...
% cd(data_dir)
disp('!!!!!  CER_analysis_01_RAW has started running  !!!!!')
...
LICK_TIMES = ALL_LICKS(find(ALL_LICKS(:,2)==1),1);
...
elseif ~sBig && offset < 0
    ...
    while i<size(CH1.values,1)
        if CH1.times(i)*1000+timeOffset<startTimes(1)
